...
var app = new Vue ({
    ...
    methods : {
        ...
        authenticate : function() {
            axios.post('http://192.168.0.104:6050/users/auth', {
                'id' : this.id,
        ...
        saveTags : function() {
            axios.post('http://192.168.0.104:6050/users/tags', {
                'id' : this.user,
    ...
    created() {
        ...
        axios.get('http://192.168.0.104:6050/trends')
            .then((response) => {
...
const socket = io('http://192.168.0.104:3000', { reconnect : true });
